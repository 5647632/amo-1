...
// ID интеграции
define('AMO_CLIENT_ID', '23cbf2e3-2cbd-4203-98ac-f4fa53d48c9f');
// Секретный ключ
define('AMO_CLIENT_SECRET', 'cbhyzkS7jkn8SK50d8EBKd0RRqlprFxN0Bm82NoAXLixIaZree72OgeRKOdgMagw');
// полный урл до файла set.token.php на вашем хостинге, какой указывали при настройке интеграции в амо
define('AMO_REDIRECT_URI', 'https://496089-analytics3.tmweb.ru/amo_all_2_db/set.token.php');
...
require_once __DIR__ . '/funcs/amo.php';
